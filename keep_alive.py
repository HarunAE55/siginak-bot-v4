"""
Sığınak Bot - Keep Alive Web Server (v5.9.1)
============================================
...
def home():
    ...
    return "🤖 Sığınak Bot v5.9.1 çevrimiçi! Veba seni bulmadan sen onu bul."


@app.route('/health')
def health():
    """Health check endpoint - Render health check için"""
    return {"status": "alive", "bot": "SiginakRP", "version": "5.9.1"}, 200
...
def keep_alive():
    ...
    t.start()
    print("🌐 Keep-alive sunucusu 8080 portunda başlatıldı. (v5.9.1)")

...
2. Tüm cog'ları yükler
3. Slash komutlarını senkronize eder
...
intents.message_content = False  # Sadece slash komutları kullanıyoruz, prefix yok

bot = commands.Bot(
    command_prefix="./",  # Cog yapısı için gerekli, ama prefix komutları kullanılmıyor
    intents=intents,
